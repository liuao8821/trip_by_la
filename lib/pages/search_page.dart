...
import 'package:tripbyla/dao/search_dao.dart';
import 'package:tripbyla/model/search_model.dart';
...
class SearchPage extends StatefulWidget {
  ...
  const SearchPage(
      {Key key, this.hideLeft, this.searchUrl = URL, this.keyword, this.hint, this.destination})
      : super(key: key);
